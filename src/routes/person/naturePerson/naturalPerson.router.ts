...
naturalPersonRoutes.put("/", 
  photoMiddleware(), 
  permission(["update_natura_person"]), 
  naturalPersonController.update);

naturalPersonRoutes.get("/:cpf", 
  permission(["get_natura_person"]), 
  naturalPersonController.show);

naturalPersonRoutes.delete("/:cpf", 
  permission(["delete_natura_person"]), 
  naturalPersonController.delete);
